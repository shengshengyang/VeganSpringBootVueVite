  ...
  <BaseLayout>
    ...
    <template #header-content-left>
      ...
      <nav class="d-none d-lg-flex align-items-center space-x-2">
        ...
        <div class="dropdown">
          <button class="btn btn-sm btn-alt-secondary" type="button" id="page-header-mega-menu-websites"
            data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fa fa-globe-americas opacity-50 me-2"></i>
            <span>Websites</span>
            <i class="fa fa-fw fa-angle-down opacity-50 ms-2"></i>
          </button>
          <div class="dropdown-menu dropdown-menu-xxl dropdown-menu-mega p-0 border-0"
            ...
            <div class="p-3">
              <div class="row g-3 fs-sm">
                <div class="col-xxl-4">
                  <BaseBlock tag="a" href="javascript:void(0)" transparent bordered link-pop class="text-center mb-0">
        ...
        <div class="dropdown">
          <button class="btn btn-sm btn-alt-secondary" type="button" id="page-header-mega-menu-apps"
            data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="row fs-sm">
                  ...
                  <ul class="list list-simple-mini mb-0">
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-file-word text-primary-lighter me-1"></i>
                        Documents
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-file-excel text-primary-lighter me-1"></i>
                        Spreadsheets
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-file-powerpoint text-primary-lighter me-1"></i>
                        Presentation
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-file-alt text-primary-lighter me-1"></i>
                        Forms
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-file-csv text-primary-lighter me-1"></i>
                        Database
                      </a>
                    </li>
                  </ul>
                ...
                <div class="col-xxl-4 mt-2 mt-xxl-0">
                  ...
                  <ul class="list list-simple-mini mb-0">
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-code text-primary-lighter me-1"></i>
                        VS Code
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-code-branch text-primary-lighter me-1"></i>
                        Repository
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-figma text-primary-lighter me-1"></i>
                        Figma
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-stack-overflow text-primary-lighter me-1"></i>
                        Stack Overflow
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-sourcetree text-primary-lighter me-1"></i>
                        Sourcetree
                      </a>
                    </li>
                  </ul>
                ...
                <div class="col-xxl-4 mt-2 mt-xxl-0">
                  ...
                  <ul class="list list-simple-mini mb-0">
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-slack text-primary-lighter me-1"></i>
                        Slack
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-discord text-primary-lighter me-1"></i>
                        Discord
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-discourse text-primary-lighter me-1"></i>
                        Discourse
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fab fa-fw fa-diaspora text-primary-lighter me-1"></i>
                        Diaspora
                      </a>
                    </li>
                    <li>
                      <a class="fw-semibold" href="javascript:void(0)">
                        <i class="fa fa-fw fa-comments text-primary-lighter me-1"></i>
                        Forum
                      </a>
                    </li>
                  </ul>
        ...
        <div class="dropdown">
          <button class="btn btn-sm btn-alt-secondary" type="button" id="page-header-mega-menu-settings"
            data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
            <i class="fa fa-cog opacity-50 me-2"></i>
            <span>Settings</span>
            <i class="fa fa-fw fa-angle-down opacity-50 ms-2"></i>
          </button>
          <div class="dropdown-menu dropdown-menu-xl dropdown-menu-mega p-0 border-0"
                ...
                <div class="row fs-sm">
                  <div class="col-xxl-6 space-y-4">
                    ...
                    <div>
                      ...
                      <div class="space-y-2">
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" value="" id="mega-settings-update-app"
                            name="mega-settings-update-app" />
                          <label class="form-check-label fs-sm" for="mega-settings-update-app">Applications</label>
                        </div>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" value="" id="mega-settings-update-sales"
                            name="mega-settings-update-sales" checked />
                  ...
                  <div class="col-xxl-6 space-y-4 mt-4 mt-xxl-0">
                    <div>
                      ...
                      <div class="space-y-2">
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" value="" id="mega-settings-email"
                            name="mega-settings-email" checked />
                          <label class="form-check-label fs-sm" for="mega-settings-email">Email Notifications</label>
                        </div>
                        <div class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" value="" id="mega-settings-sms"
                    ...
                    <div>
                      ...
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" value="" id="mega-settings-api"
                          name="mega-settings-api" checked />
