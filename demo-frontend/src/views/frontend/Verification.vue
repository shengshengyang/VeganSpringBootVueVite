...
async function verify() {
    ...
    var mail = localStorage.getItem("registerInfo");
    console.log(mail);
    formData.append("status", '正常');
    formData.append("email", mail);

    axios.patch("http://localhost:8088/user/updateStatus", formData,
        {
            headers: {
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="mb-4">
                                        <input type="password" maxlength="20"
                                            class="form-control form-control-lg form-control-alt" id="signup-password"
