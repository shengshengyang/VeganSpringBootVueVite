    ...
    <div class="content content-full text-center">
      <div class="my-3">
        <img class="img-avatar img-avatar-thumb"
          :src="`/assets/media/business/${business.data.business.businessPic}.jpg`" alt="business" />
      </div>
      <h1 class="h2 text-white mb-0">{{ business.data.business.businessName }}</h1>
      <span class="text-white-75">{{ business.data.business.principalName }}</span>
    </div>
  </BaseBackground>
  <!-- END Hero -->
      ...
      <div class="col-md-7 col-xl-8">
        ...
        <ul class="timeline timeline-alt py-0">
          ...
          <li class="timeline-event">
            ...
            <BaseBlock title="Products" class="timeline-event-block" content-full>
              <template #options>
                <div class="timeline-event-time block-options-item fs-sm">
                  2 months ago
                </div>
