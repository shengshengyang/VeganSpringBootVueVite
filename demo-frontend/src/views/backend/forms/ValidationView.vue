...
<template>
  <!-- Hero -->
  <BasePageHeading title="Form Validation" subtitle="It’s never been easier to validate form values.">
    <template #extra>
        ...
        <div class="row items-push">
          ...
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
              ...
              }" v-model="state.username" @blur="v$.username.$touch" placeholder="Enter a username.." />
            ...
            <div class="mb-4">
              ...
              }" v-model="state.email" @blur="v$.email.$touch" placeholder="Your valid email.." />
            ...
            <div class="mb-4">
              ...
              }" v-model="state.password" @blur="v$.password.$touch" placeholder="Choose a safe one.." />
            ...
            <div class="mb-4">
              ...
              }" v-model="state.confirmPassword" @blur="v$.confirmPassword.$touch" placeholder="..and confirm it!" />
        ...
        <div class="row items-push">
          ...
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
              ...
              <textarea id="val-suggestions" class="form-control" :class="{
                'is-invalid': v$.suggestions.$errors.length,
              }" rows="5" v-model="state.suggestions" @blur="v$.suggestions.$touch"
                placeholder="What would you like to see?"></textarea>
              <div v-if="v$.suggestions.$errors.length" class="invalid-feedback animated fadeIn">
                What can we do to become better?
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-skill">Best Skill <span class="text-danger">*</span></label>
              <select id="val-skill" class="form-select" :class="{
                'is-invalid': v$.skill.$errors.length,
              }" v-model="state.skill" @blur="v$.skill.$touch">
                <option v-for="(option, index) in options" :value="option.value" :key="`option-${index}`">
                  {{ option.text }}
                </option>
              </select>
              <div v-if="v$.skill.$errors.length" class="invalid-feedback animated fadeIn">
                Please select a skill!
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-currency">Currency (USD) <span class="text-danger">*</span></label>
              <input type="text" id="val-currency" class="form-control" :class="{
                'is-invalid': v$.currency.$errors.length,
              }" v-model="state.currency" @blur="v$.currency.$touch" placeholder="21.60" />
              <div v-if="v$.currency.$errors.length" class="invalid-feedback animated fadeIn">
                Please enter a price!
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-website">Website <span class="text-danger">*</span></label>
              <input type="text" id="val-website" class="form-control" :class="{
                'is-invalid': v$.website.$errors.length,
              }" v-model="state.website" @blur="v$.website.$touch" placeholder="https://example.com" />
              <div v-if="v$.website.$errors.length" class="invalid-feedback animated fadeIn">
                Please enter your website!
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-digits">Digits <span class="text-danger">*</span></label>
              <input type="text" id="val-digits" class="form-control" :class="{
                'is-invalid': v$.digits.$errors.length,
              }" v-model="state.digits" @blur="v$.digits.$touch" placeholder="5" />
              <div v-if="v$.digits.$errors.length" class="invalid-feedback animated fadeIn">
                Please enter only digits!
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-number">Number <span class="text-danger">*</span></label>
              <input type="text" id="val-number" class="form-control" :class="{
                'is-invalid': v$.number.$errors.length,
              }" v-model="state.number" @blur="v$.number.$touch" placeholder="5.0" />
              <div v-if="v$.number.$errors.length" class="invalid-feedback animated fadeIn">
                Please enter a number!
              </div>
            </div>
            <div class="mb-4">
              <label class="form-label" for="val-range">Range [1, 5] <span class="text-danger">*</span></label>
              <input type="text" id="val-range" class="form-control" :class="{
                'is-invalid': v$.range.$errors.length,
              }" v-model="state.range" @blur="v$.range.$touch" placeholder="4" />
              <div v-if="v$.range.$errors.length" class="invalid-feedback animated fadeIn">
